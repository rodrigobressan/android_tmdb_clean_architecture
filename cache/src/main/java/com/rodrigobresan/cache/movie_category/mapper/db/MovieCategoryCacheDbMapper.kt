...
/**
 * Mapper for Category entity. Maps MovieCategoryCached <-> ContentValues
 */
class MovieCategoryCacheDbMapper @Inject constructor() : ModelCacheMapper<MovieCategoryCached> {
